...
<head>
    ...
    <style>
        ...
        .topbar-title { font-weight: 600; font-size: 1.05rem; color: #1e2a3a; }
        ...
        /* ---- STAT CARDS ---- */
        .stat-card { border-radius: 12px; padding: 22px 24px; color: #fff; }
        .stat-card .stat-label { font-size: .78rem; opacity: .8; text-transform: uppercase; letter-spacing: .5px; }
        ...
        /* ---- FOOTER ---- */
        .main-footer { padding: 14px 28px; font-size: .8rem; color: #aaa; border-top: 1px solid #e9ecef; }
